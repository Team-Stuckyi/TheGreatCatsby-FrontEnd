...
import { getMemberList } from 'slices/admin/MemberSlice';
import { editMemberList } from 'slices/admin/MemberSlice';
import { delMemberList } from 'slices/admin/MemberSlice';
...
const ManageAdmin = () => {
    ...
    //테이블 width 설정
    const columnsWidth = ['50px', '180px', '100px', '150px', '260px', '80px', '160px'];
    //테이블 컬럼명
    const columns = ['no', '아이디', '이름', '연락처', '주소', '상태', '가입일자'];
    //테이블 관리 파트
