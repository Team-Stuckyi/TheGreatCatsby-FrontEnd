...
const TableListWithoutPagination = ({ columns, data, isModifiable, isRemovable, onModifyButtonClick, onRemoveButtonClick, removeButtonText, onChange, onChecked }) => {
...
export default TableListWithoutPagination;